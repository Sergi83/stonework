// Banner, About, Main(GeneralInf), Footer
export const content = {
  ...
  about: {
    ...
    boxes: [
      {
        name: "box1",
        imgSrc: "../styles/images/cloud_icon.svg",
        imgAlt: "cloud_icon",
        textP: "Praesent pellentesque facilisis elit. Class aptent taciti sociosqu ad  torquent per conubia nostra.",
        buttonLink: "/contact",
      },
      {
        name: "box2",
        ...
        imgAlt: "gears_icon",
        textP: "Etiam neque. Vivamus consequat lorem at nisl. Nullam  wisi a sem semper eleifend. Donec mattis.",
        buttonLink: "/contact",
      },
      {
        name: "box3",
        ...
        imgAlt: "wrench_icon",
        textP: "Aenean lectus lorem, imperdiet at, ultrices eget, ornare et, wisi. Pellentesque adipiscing purus.",
        buttonLink: "/contact",
      },
    ],
  },
